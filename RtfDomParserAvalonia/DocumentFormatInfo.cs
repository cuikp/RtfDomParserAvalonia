...
namespace RtfDomParser
{
   ...
   public class DocumentFormatInfo
   {
      ...
      private Color intBorderColor = Colors.Black;
      /// <summary>
      /// Border line color
      /// </summary>
      ...
      private IDashStyle _BorderStyle = DashStyle.Dash;
      public IDashStyle BorderStyle
      {
         get => _BorderStyle;
      ...
      private Color intTextColor = Colors.Black;
      [DefaultValue(typeof(Color), "Black")]
      public Color TextColor
      {
         get => intTextColor;
         set => intTextColor = value;
      }

      private Color intBackColor = Colors.Transparent;
      ...
      public Color BackColor
      {
         ...
         {
            intBackColor = value;
            //Debug.WriteLine("Set backcolor to: " + value.ToString());
         }
      }
